...
var _user$project$Models$Entry = function (a) {
	return {name: a};
};
var _user$project$Models$RoomModel = F4(
	function (a, b, c, d) {
		return {entries: a, title: b, description: c, currentEntry: d};
	});

var _user$project$Decoders$entryDecoder = A2(
	_elm_lang$core$Json_Decode$object1,
	_user$project$Models$Entry,
	A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string));
var _user$project$Decoders$RoomInfo = F3(
	function (a, b, c) {
		return {entries: a, title: b, description: c};
	});
var _user$project$Decoders$roomDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Decoders$RoomInfo,
	A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'entries',
		_elm_lang$core$Json_Decode$list(_user$project$Decoders$entryDecoder)),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode_ops[':='], 'description', _elm_lang$core$Json_Decode$string));

var _user$project$Messages$SendSuccess = function (a) {
	return {ctor: 'SendSuccess', _0: a};
};
var _user$project$Messages$SendFail = function (a) {
	return {ctor: 'SendFail', _0: a};
};
var _user$project$Messages$Store = {ctor: 'Store'};
var _user$project$Messages$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$Messages$NoOp = {ctor: 'NoOp'};

var _user$project$Views_ListItem$listItem = function (entry) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(entry.name)
			]));
};
var _user$project$Views_ListItem$listItems = function (entries) {
	return A2(_elm_lang$core$List$map, _user$project$Views_ListItem$listItem, entries);
};
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$html$Html_Attributes$maxlength(15),
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Events$onClick(_user$project$Messages$Store)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('Meld meg på')
											]))
									])),
								A2(
								_elm_lang$html$Html$div,
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												_elm_lang$core$Native_List.fromArray(
													[
														_elm_lang$html$Html_Attributes$class('entries')
													]),
												_user$project$Views_ListItem$listItems(model.entries))
											]))
									]))
							]))
					]))
...
var _user$project$Main$requestParams = F2(
	function (url, encName) {
		return {
			verb: 'PUT',
			headers: _elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$Main$postEntries = F2(
	function (url, currentEntry) {
		var encodedCurrent = _evancz$elm_http$Http$string(
			A2(
		...
		return A3(
			...
			_user$project$Messages$SendFail,
			_user$project$Messages$SendSuccess,
			A2(
				_evancz$elm_http$Http$fromJson,
				...
				A2(
					...
					A2(_user$project$Main$requestParams, url, encodedCurrent))));
	});
		...
		switch (_p0.ctor) {
			...
			case 'Input':
				return {
					ctor: '_Tuple2',
					_0: A4(
						_user$project$Models$RoomModel,
						model.entries,
						model.title,
						model.description,
						_user$project$Models$Entry(_p0._0)),
			...
			case 'Store':
				return {
					...
					_0: model,
					_1: A2(
						_user$project$Main$postEntries,
						A2(
							_elm_lang$core$Basics_ops['++'],
							'/api/',
							A2(_elm_lang$core$Basics_ops['++'], model.title, '/entry')),
						function (entry) {
							return entry.name;
						}(model.currentEntry))
				};
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{entries: _p1.entries, title: _p1.title, description: _p1.description}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$init = function (flags) {
	...
	return {
		...
		_0: A4(
			...
			_user$project$Models$Entry('')),
		_1: _user$project$Main$getEntries(room)
	};
};
