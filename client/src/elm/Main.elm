                    ...
                    , div [ class "row entry" ]
                        [ form [ onWithOptions "submit" (Options True True)  (Json.Decode.succeed Store) ]
                            [ div [ class "mdl-textfield mdl-js-textfield" ]
                                [ input [ class "mdl-textfield__input", type_ "text", id "entryInput", maxlength 50, autofocus True, onInput Input, onSubmit Store ] []
                                  , label [ class "mdl-textfield__label", for "entryInput" ] [ text "Navn"]
                                ]
                            ]
